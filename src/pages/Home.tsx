  ...
  return <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          ...
          {mobileMenuOpen && <nav className="md:hidden mt-4 pb-4 space-y-2">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <BatterySearchBar searchQuery={searchQuery} setSearchQuery={setSearchQuery} onSearch={handleSearch} onImageUpload={handleImageUpload} />
          ...
          <div id="order-options" className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 justify-center items-start mb-16 max-w-7xl mx-auto">
            <Card className="p-8 bg-card/80 backdrop-blur-sm border-primary/30 hover:border-primary/60 transition-all duration-300 cursor-pointer group h-full flex flex-col" onClick={() => navigate('/order/home')}>
              <img src={residentialImage} alt="Residential Installation" className="w-full h-48 object-cover rounded-lg mb-6" />
            ...
            <Card className="p-8 bg-card/80 backdrop-blur-sm border-primary/30 hover:border-primary/60 transition-all duration-300 cursor-pointer group h-full flex flex-col" onClick={() => navigate('/order/business')}>
              <img src={commercialImage} alt="Commercial Installation" className="w-full h-48 object-cover rounded-lg mb-6" />
            ...
            <Card className="p-8 bg-card/80 backdrop-blur-sm border-primary/30 hover:border-primary/60 transition-all duration-300 cursor-pointer group h-full flex flex-col" onClick={() => navigate('/oem-portal')}>
              <img src="/lovable-uploads/736a564e-d9c1-438d-a51a-b38598c2e7f1.png" alt="Battery Collection" className="w-full h-48 object-contain rounded-lg mb-6 bg-gradient-to-br from-primary/10 to-primary/20 p-4" />
            ...
            <Card className="p-8 bg-card/80 backdrop-blur-sm border-primary/30 hover:border-primary/60 transition-all duration-300 cursor-pointer group h-full flex flex-col" onClick={() => navigate('/dashboard')}>
              <img src="/lovable-uploads/cf318afd-38d2-4336-b796-5d6acdd72e15.png" alt="Battery Cloud Monitoring" className="w-full h-48 object-contain rounded-lg mb-6 bg-gradient-to-br from-blue-50 to-gray-50 p-2" />
      ...
      <section id="services" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => <Card key={index} className="p-6 bg-white border-gray-200 hover:border-primary/50 transition-all duration-300 shadow-sm">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/dc90c0d6-f599-4c68-9469-d51774bac39b.png" alt="Lithium Polymer Line Machinery Cost" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/32d400fa-cd79-4ae1-b5d8-959d4f987f74.png" alt="Solar and RF Integrated Batteries" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/de3975bc-b162-4cee-8de2-2d2ba7c921ee.png" alt="Production Outputs" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/abadfbd4-3928-44f6-bd51-ee541ad0293c.png" alt="Mitsubishi Solutions Layout" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/b781b11d-608e-4f40-8b38-14537ad4523c.png" alt="Automatic Pouch Cell Production" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/df3fbd9a-e73d-4417-8dad-6c93583b89b6.png" alt="Production Flow Diagram" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/22debe8c-46de-4daa-bbf0-86d5400fff18.png" alt="Formation and Sealing" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/ffc7cfbc-938c-4ed0-9382-7f8f12645a2b.png" alt="Cell Assembly Process" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow">
              <img src="/lovable-uploads/945ee79d-d87e-436c-93f2-df5f7c70f13c.png" alt="Electrode Sheet Preparation" className="w-full h-48 object-cover rounded-lg mb-4" />
            ...
            <Card className="p-4 bg-white shadow-lg hover:shadow-xl transition-shadow md:col-span-2 lg:col-span-1">
              <img src="/lovable-uploads/ce4a6b7d-e18a-41a1-97cf-245a6bb13a8e.png" alt="South Africa Manufacturing Plant" className="w-full h-48 object-cover rounded-lg mb-4" />
